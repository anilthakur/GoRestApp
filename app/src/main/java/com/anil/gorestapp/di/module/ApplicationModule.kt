...
class ApplicationModule {
    ...
    @Singleton
    @Provides
    fun provideOfferRepo(api: RetrofitService, dao: PersonDao, schedulerProvider: BaseSchedulerProvider, connectivityManager: ConnectivityManager, isTest: Boolean): PersonRepo = PersonRepoImpl(api, dao, schedulerProvider, connectivityManager, isTest)
